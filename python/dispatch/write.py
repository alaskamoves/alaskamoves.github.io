...
<footer>
    <p><a href="https://alaskamoves.us/index.html"><code>return.dispatch(self) ↩︎</code></a></p>
    <p><a href="https://alaskamoves.us/index.html"><code>return.(self) ↩︎</code></a></p>
</footer>
...
# Paths and metadata
DRAFTS_DIR = Path("../python/dispatch/drafts/")
